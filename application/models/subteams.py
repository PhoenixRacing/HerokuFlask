...
body = Subteam()
body.name = 'body'
body.image_path = 'img/chassis-icon.png'
body.short_description = 'Designs our frame from 4130 chromoly steel tube and performs structural analysis.'
body.description = 'Body Subteam is in charge of the chassis, stylistic elements, and driver interface. Goals for this year include making the chassis smaller and making sure that everyone on the team can drive the car safely and comfortably.\nThis year will be the third year in a row that the team is building an entirely new car, which opens up many opportunities for redesign and testing. Some examples of redesign for this year include making the car smaller overall to cut down weight and increase maneuverability and handling, to take a look at different types of bracing to make sure the car can handle significant impacts, and to ensure that all members of the team can drive the car safely and in accordance with the SAE technical rules. We learned a lot while designing the chassis last year and will include elements such as ease of manufacturing that were vital to building the last car.\nUsing FEA (Finite Element Analysis) we are able to simulate impacts on the car to ensure driver safety. We build sketch models around drivers to help visualize designs and improve driver interface. These and other techniques are combined with SolidWorks CAD to design a car to meet our goals.\nBuilding the chassis is not possible without the help of the Olin Machine Shop where team members are trained to use a variety of techniques and machines to help put the car together. We use tools like the water jet cutter and CNC router to ensure that parts are made with precision.'
