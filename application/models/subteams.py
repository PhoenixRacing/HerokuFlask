...
electrical.description = 'Electrical is the newest Phoenix Racing subsystem. We\'re responsible for everything from wiring the car\'s brake lights, to monitoring car speed, to maintaining the team website.\n This year, we will be focusing on creating simulations to validate the subsystem designs for drivetrain, body, and suspension. We will also be equipping the car with a sensor suite to allow us to conduct real-time failure analysis on the car and to provide the driver with useful data during races and practice drives. Lastly, we will be implementing a reliable driver communication system for use during the endurance race.'
